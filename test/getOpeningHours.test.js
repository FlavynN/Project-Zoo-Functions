...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Para os argumentos Sunday e 09:65-AM deve lançar uma exceção com a mensagem: The minutes must be between 0 and 59', () => {
    expect(() => getOpeningHours('Sunday', '09:65-AM')).toThrow(new Error('The minutes must be between 0 and 59'));
  });
  it('Para os argumentos Monday e 13:05-AM deve lançar uma exceção com a mensagem: The hour must be between 0 and 12', () => {
    expect(() => getOpeningHours('Sunday', '13:05-AM')).toThrow(new Error('The hour must be between 0 and 12'));
  });
});
